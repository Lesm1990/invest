...
<main>
	<div class="row">
		...
		<fieldset class="row">
			<legend><h6>Nuevo Empleado</h6></legend>
	        ...
	        <div class="col s12">
	        	<button class="btn waves-effect waves-light right" type="submit" name="action">Agregar Empleado
			...
			<fieldset class="row">
				<legend><h6>Ver Empleados</h6></legend>
		        ...
		        <tbody>
		        	...
		        	<tr>
		        		<td></td>
		                <td>{{$e->id}}</td>
		                <td>{{$e->tipoidentificacion->descripcion}} {{$e->identificacion}}</td>
		                <td>{{$e->nombre}} {{$e->apellido}}</td>
		                <td>{{$e->telefono}}</td>
		                <td>{{$e->email}}</td>
		                <td>{{$e->direccion}}</td>
		                <td class="center ">
		                	{{ Form::open([ 'method'  => 'delete', 'url' => 'empleados/'.$e->id ]) }}
		                		<a href="{{ url('/empleados/'.$e->id.'/edit') }}" style="margin:15px;" class="center tooltipped" data-position="top" data-delay="50" data-tooltip="Editar">
